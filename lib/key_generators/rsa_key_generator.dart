...
class RSAKeyGenerator implements KeyGenerator {
  ...
  AsymmetricKeyPair generateKeyPair() {
    ...
    int strength = _params.bitStrength;
    ...
    for (;;) {
      ...
      if (!isProbablePrime(p, _params.certainty)) {
        continue;
      }
    ...
    for (;;) {
      ...
      for (;;) {
        ...
        if (!isProbablePrime(q, _params.certainty)) {
          continue;
        }
    ...
    BigInt pSub1 = (p - BigInt.one);
    BigInt qSub1 = (q - BigInt.one);
